...
namespace App\Api\OutgoingDocumentCategory;

use App\Http\Controllers\CrudController;
use Illuminate\Http\Request;

use App\Models\OutgoingDocumentCategory;
use Illuminate\Support\Facades\Validator;
use Illuminate\Http\JsonResponse;
use Illuminate\Validation\Rule;

class OutgoingDocumentCategoryController extends CrudController
{
    //
    public function __construct()
    {
        $this->model =  new OutgoingDocumentCategory();
        $this->modelQuery = $this->model;
        $this->validation = [
            "rules"=>[
                "name"=>["required",Rule::unique('outgoing_document_categories')->ignore(request('id'))]
            ],
            "message"=>[
